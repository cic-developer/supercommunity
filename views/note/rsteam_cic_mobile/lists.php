<?php 
	//페이지별 언어팩 로드
	$this->lang->load('cic_note_mobile_lists', $this->session->userdata('lang'));

	$this->managelayout->add_css(element('view_skin_url', $layout) . '/css/style.css?v=3'); 
?>
...
<div class="modal-body">
	...
	<div class="pull-right" style="margin:20px;"><button class="btn btn-default" onClick="window.close();"><?=$this->lang->line(13)?></button></div>
</div>
