...
<div id="my_right_box">
    ...
    <div class="my_cont_area">
        ...
        <table cellpadding="0" class="list_table" cellspacing="0" width="100%">
            ...
            ?>
                <tr>
                    ...
                    <!-- <td>
                            <i class="super_p"></i><b><?php //echo $ml['med_superpoint']
                                                        ?></b> 
                        </td> -->
                    <td>
                        ...
                        <!-- <i class="per_p"></i><b><?php //echo number_format($expected_point, 1) 
                                                        ?></b>  -->
                    </td>
                    <td>
        ...
        <div class="mission_check">
            <a href="<?php echo base_url('Mission/detailMission/' . element('mis_id', $missionData)) ?>" target="_blank"> <?php echo $this->lang->line(3) ?> <i class="fas fa-plus"></i></a>
            <!--게시글 링크로 이동-->
