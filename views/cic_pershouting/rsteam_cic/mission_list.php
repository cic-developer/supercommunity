...
?>
 ...
 <!--일단 몰라서 디테일에서 떼와서 붙였음 수정히시면 됩니다-->
 <!-- 힝구 세심한 배려 감사합니당! -->
<?php 
    // 마감 시간
    $_now = time();
...
<?php }else if(element('mis_thumb_type', $d) == 2){ ?>
                            <iframe src="https://www.youtube.com/embed/<?php echo rs_get_YT_id(element('mis_thumb_youtube',$d))?>?mute=1&controls=0&rel=0" 
                            frameborder="0" 
...
<script src="/assets/js/multi-countdown.js?ver=2"></script>
<script>
    //미션 검색
