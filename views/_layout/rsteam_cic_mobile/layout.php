		...
		<!--footer_wrap-->
			<div class="footer_top">
				...
				<dl class="bt_all">
					...
					<dd>
						<a href="https://play.google.com/store/apps/details?id=com.perwallet"> <img src="<?php echo base_url('assets/images/google.png');?>" alt="<?php echo $this->lang->line('cic_27')?>"/> </a>
					</dd>
					<dd>
