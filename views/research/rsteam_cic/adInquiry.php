...
<div id="research_wrap">  
    <div class="research_content">
        <div id="research_page1" class="research_top research_page" style="display:block">
            <h3>&nbsp;&nbsp;&nbsp;<?php echo $this->lang->line('h3_1')?><br/><small><?php echo $this->lang->line('small_1')?></small></h3>
            <form id="page1">
                <ul class="text_g">
                    <li class="sub_title">
                    ...
                    <li class="form-group"><p>
                        <input id="res_name" name="res_name" type="text" placeholder="<?php echo $this->lang->line('res_name_placehold')?>" />
                    </p></li>
                    ...
                    <li>
                        <div class="bt">
                            <a class="btn1 btn_yellow" onclick="research_next(1)"><?php echo $this->lang->line('next_button')?></a>
                        </div>
                    </li>
                </ul>
            </form>
        ...
        <div id="research_page2" class="research_top research_page" style="display:none" >
            ...
            <ul class="text_g">
                ...
                <li>
                    <div class="bt">
                        <a class="btn1 btn_black" onClick="research_back(2)"><?php echo $this->lang->line('pre_button')?></a>
                        <a class="btn1 btn_yellow" onClick="research_next(2)"><?php echo $this->lang->line('next_button')?></a>
                    </div>
                </li>
            </ul>
            </form>
        ...
        <div id="research_page3" class="research_top research_page"  style="display:none">
            ...
            <ul class="text_g">
                ...
                <li>
                    <div class="bt">
                        <a class="btn1 btn_black" onClick="research_back(3)"><?php echo $this->lang->line('pre_button')?></a>
                        <a class="btn1 btn_yellow" onClick="research_next(3)"><?php echo $this->lang->line('next_button')?></a>
                    </div>
                </li>
            </form>
        </div>
        ...
        <div id="research_page4" class="research_top research_page"  style="display:none">
            <br>
            <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->lang->line('h3_4')?>
            </h3><br>
            <form id="page4">
            <ul class="text_g">
                <li class="sub_title">
                ...
                <li>
                    <div class="bt">
                        <a class="btn1 btn_black" onClick="research_back(4)"><?php echo $this->lang->line('pre_button')?></a>
                        <a class="btn1 btn_yellow" onClick="research_next(4)"><?php echo $this->lang->line('submit_button')?></a>
                    </div>
                </li>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $("#page1").validate({
            rules: {
                res_name : { required: true, rangelength: [2 , 50]},
                res_category: { required: true },
                res_contents: { required: true, minlength:2 ,maxlength: 1000 }
            },
        ...
        $("#page2").validate({
            rules: {
                res_when : { required: true },
                res_howlong: { required: true },
            },
            errorPlacement:function(error, element){
                if(element.is(":radio") || element.is(":checkbox")) {
                    console.log(element.closest('.form-group'))
        ...
        $("#page4").validate({
            rules: {
                res_email: { required: true, email: true, rangelength: [9 , 100] },
                res_tel: { required: true, minlength: 2, rangelength: [9, 13], expr: /^[0-9]{2,3}[0-9]{3,4}[0-9]{4}/},
            },
            errorPlacement:function(error, element){
                if(element.is(":radio") || element.is(":checkbox")) {
                    element.closest('.form-group').append(error);
    ...
    $('input[type="radio"][name="res_package"]').on('click', function(){
        if(!radio_flag){
            radio_flag = $(this).val();
        }else{
            let checked_val = $(this).val();
            if(radio_flag === checked_val){
                radio_flag = '';
