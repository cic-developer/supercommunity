    ...
    <div class="white_content">
        ...
        <div class="white_b" id="hiddenContent01" style="display: none;">
            ...
            <div class="content_area">
             ...
             <div class="content_area">
                <h4><?php //echo $this->lang->line(6) 
                    ?></h4>
                <ul class="text_g">
                    <li>
                        <p><?php //echo $this->lang->line(7) 
                            ?></p>
                    </li>
                    <li class="s_img">
                        <img src="<?php //echo base_url('assets/images/white011'.$is_en.'.jpg');
                                    ?>" alt=" <?php //echo $this->lang->line(20) 
                                                                                                            ?>"/>
                    </li>
                    <li>
                    ...
                    <li class="img">
                        <img src="<?php //echo base_url('assets/images/white012'.$is_en.'.jpg');
                                    ?>" alt=" <?php //echo $this->lang->line(21) 
                                                                                                            ?>"/>
                    </li>
                    <li class="sub_title">
                    ...
                    <li class="img">
                        <img src="<?php //echo base_url('assets/images/white013'.$is_en.'.jpg');
                                    ?>" alt=" <?php //echo $this->lang->line(22) 
                                                                                                            ?>"/>
                    </li>
                    <li>
                        <p><?php //echo $this->lang->line(15) 
                            ?></p>
                    </li>
                    <li class="img">
                       <img src="<?php //echo base_url('assets/images/white014'.$is_en.'.jpg');
                                    ?>" alt=" <?php //echo $this->lang->line(23) 
                                                                                                            ?>"/>
                    </li>
                    <li>
                    <p> <?php //echo $this->lang->line(16) 
                        ?></p>
                    </li>
                </ul>
            </div> -->
