...
<div class="mypage">
	...
	<h3>포인트 내역 <small>보유 포인트 : <?php echo number_format($this->member->item('mem_point'),1); ?>점</small></h3>
	...
	<table class="table">
		...
		?>
			<tr>
				...
				<td><?php if (element('poi_point', $result) > 0) { ?><span class="label label-success">+<?php echo number_format(element('poi_point', $result),1); ?></span><?php } ?></td>
				<td><?php if (element('poi_point', $result) < 0) { ?><span class="label label-danger"><?php echo number_format(element('poi_point', $result),1); ?></span><?php } ?></td>
			</tr>
		<?php
			}
		}
		...
		?>
			<tr class="success">
				...
				<td></td>
				<td></td>
				<td>+<?php echo number_format(element('plus', element('data', $view)),1); ?></td>
				<td><?php echo number_format(element('minus', element('data', $view)),1); ?></td>
			</tr>
		</tbody>
	</table>
