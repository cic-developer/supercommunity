		...
		?>
			...
			<div class="form-group">
				...
				<div class="col-sm-10" style="min-height:30px; padding-top:7px;">
					<?php echo element('inq_name', element('data', $view)); ?>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">문의 단체</label>
				<div class="col-sm-10" style="min-height:30px; padding-top:7px;">
					<?php echo element('inq_group', element('data', $view)); ?>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">회신 이메일</label>
				<div class="col-sm-10" style="min-height:30px; padding-top:7px;">
					<?php echo element('inq_email', element('data', $view)); ?>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">연락처</label>
				<div class="col-sm-10" style="min-height:30px; padding-top:7px;">
					<?php echo element('inq_tel', element('data', $view)); ?>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">작성일</label>
				<div class="col-sm-10" style="min-height:30px; padding-top:7px;">
					<?php echo element('inq_wdate', element('data', $view)); ?>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">문의 내용</label>
				<div class="col-sm-10" style="min-height:30px; padding-top:7px;">
					<?php echo preg_replace('(&lt;br&gt;|&lt;br \/&gt;)', "<br />", html_escape(element('inq_contents', element('data', $view)))); ?>
				</div>
			</div>
