<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs">
			<li role="presentation"><a href="<?php echo admin_url($this->pagedir); ?>" onclick="return check_form_changed();">문구</a></li>
			<li role="presentation" class="active"><a href="<?php echo admin_url($this->pagedir . '/background'); ?>" onclick="return check_form_changed();">배경이미지/영상</a></li>
		</ul>
	</div>
	<div class="box-table">
		<?php
