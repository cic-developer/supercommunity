		...
		?>
			...
			<div class="table-responsive">
				<table class="table table-hover table-striped table-bordered">
					<thead>
						<tr>
							<th><a href="<?php echo element('wht_id', element('sort', $view)); ?>">번호</a></th>
							<th>제목</th>
							<th>도메인</th>
							<th>메모</th>
							<th>작성자</th>
							<th><a href="<?php echo element('wht_wdate', element('sort', $view)); ?>">작성일</a></th>
							<th>수정</th>
					...
					?>
						<tr>
							...
							<td><?php echo html_escape(element('domain', $result)); ?></td>
