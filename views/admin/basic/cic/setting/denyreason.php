		...
		?>
			<div class="box-table-header">
				<div class="btn-group btn-group-sm" role="group">
					<a href="<?php echo element('listall_url', $view); ?>?judr_jug_id=1" class="btn btn-sm <?php echo ($this->input->get('judr_jug_id') != 2 && $this->input->get('judr_jug_id') != 3) ? "btn-success" : "btn-default"; ?>">미션심사</a>
					<a href="<?php echo element('listall_url', $view); ?>?judr_jug_id=2" class="btn btn-sm <?php echo $this->input->get('judr_jug_id') == 2 ? "btn-success" : "btn-default"; ?>">미디어심사</a>
					<a href="<?php echo element('listall_url', $view); ?>?judr_jug_id=3" class="btn btn-sm <?php echo $this->input->get('judr_jug_id') == 3 ? "btn-success" : "btn-default"; ?>">출금심사</a>
				</div>
				<?php
				ob_start();
				?>
