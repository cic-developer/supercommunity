...
=======
							<td>
								<img 
									class="img_modal" 
									src="<?php echo thumb_url('judge', element('jud_attach', $result), 200, 160); ?>" 
									alt="제출이미지" 
									title="제출이미지" 
									<?php //style="cursor:pointer;"?> 
									onclick="window.open('<?php echo element('jud_post_link', $result)?>')" 
									<?php // echo data-img="thumb_url('judge', element('jud_attach', $result), 800, 600)"?>
								/>
							</td>
>>>>>>> 437adc51367ae198bbc465815a250b073329e208
