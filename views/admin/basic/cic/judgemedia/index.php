				...
				<table class="table table-hover table-striped table-bordered">
					...
					?>
						<tr>
							...
							<td>
								<a href="<?php echo element('jud_med_url', $result); ?>" target="_blank">
									<?php echo mb_strlen(element('jud_med_url', $result)) > 15 ? mb_substr(element('jud_med_url', $result),0,15).'...' : element('jud_med_url', $result); ?>
								</a>
								<?php if(element('med_duplicate',$result)){ ?>
									<a href="/admin/cic/judgemedia?sfield=jud_med_url&skeyword=<?php echo urlencode(element('jud_med_url', $result)); ?>&search_submit=">
