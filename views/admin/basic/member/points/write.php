<div class="box">
	<div class="box-table">
		...
		<div class="box-table-header">
			<h4><a data-toggle="collapse" href="#collapse1" aria-expanded="true" aria-controls="collapse1">특정 회원 퍼포인트 추가</a></h4>
		...
		<div class="collapse in" id="collapse1">
			...
			?>
				...
				<div class="form-group">
					<label class="col-sm-2 control-label">퍼포인트</label>
					<div class="col-sm-10">
				...
				<div class="btn-group pull-right" role="group" aria-label="...">
					<button type="submit" class="btn btn-outline btn-success btn-sm">특정회원 퍼포인트 추가하기</button>
				</div>
			<?php echo form_close(); ?>
		</div>
	</div>
	<div class="box-table">
		<div class="box-table-header">
			<h4><a data-toggle="collapse" href="#collapse2" aria-expanded="true" aria-controls="collapse2">모든 회원 동시 퍼포인트 추가</a></h4>
		...
		<div class="collapse in" id="collapse2">
			...
			?>
				...
				<div class="btn-group pull-right" role="group" aria-label="...">
					<button type="submit" class="btn btn-outline btn-success btn-sm">모든 회원 퍼포인트 동시 추가</button>
				</div>
			<?php echo form_close(); ?>
		</div>
	</div>
