...
<div id="board_wrap">
<div class="board">
	<h5><?php echo html_escape(element('board_name', element('board', $view))); ?></h5>
	<?php
	...
	?>
		...
		<ul class="writeform">
			<?php if (element('is_post_name', element('post', $view))) { ?>
				...
				<li>
					<span>이메일</span>
					<input type="text" class="input" name="post_email" id="post_email" value="<?php echo set_value('post_email', element('post_email', element('post', $view))); ?>" />
				</li>
				<li>
					<span>홈페이지</span>
					<input type="text" class="input" name="post_homepage" id="post_homepage" value="<?php echo set_value('post_homepage', element('post_homepage', element('post', $view))); ?>" />
				</li>
			<?php } ?>
			<li>
				<span>제목</span>
				<div>
					<input type="text" class="input" name="post_title" id="post_title" value="<?php echo set_value('post_title', element('post_title', element('post', $view))); ?>" />
			...
			?>
				<li>
					...
					<input type="text" class="input" name="<?php echo $link_column; ?>" value="<?php echo set_value($link_column, $link); ?>" />
				</li>
			<?php
				}
			}
