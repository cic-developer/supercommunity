 ...
 */
$autoload['libraries'] = array('session', 'managelayout', 'member', 'cbconfig', 'board', 'user_agent', 'events','point');
 ...
 */
$autoload['helper'] = array('url', 'basic', 'thumbnail', 'cookie','RS_common');
...
*/
$autoload['model'] = array('Member_model', 'Note_model');
