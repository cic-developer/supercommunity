...
// PER 광고 컨설팅 문의
$lang[0] = 'SUPER COMMUNITY <br>Advertising Consulting';  //좌측 백색구역
$lang[1] = 'If the advertisement is not yet completed, you can request the Super Community to make manuscripts, videos, and other advertisements! ';  //우측 문구
$lang[2] = '1. Could you tell us a few things? '; //개인정보 조사
$lang[3] = 'Name ';   //이름 placeholder
$lang[4] = 'Workplace, Group Name ';   //직장, 단체명 placeholder
$lang[5] = 'Email '; //이메일 placeholder
$lang[6] = 'Contact number '; //연락처 placeholder
$lang[7] = '2. How can I help you? ';   //문의내용
...
$lang[14] = 'Email '; // validation 
$lang[15] = 'Phone number';   // validation 
$lang[16] = 'Inquiries';  // validation 
$lang[17] = 'Privacy Policy';  // validation 
