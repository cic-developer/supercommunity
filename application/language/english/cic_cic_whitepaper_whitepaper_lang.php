...
<ul class="text_g">
    ...
    <li>
        <p> All PER tokens paid by advertisers as advertising expenses are distributed to Per Friends, which remains as a record on the block chain to check the execution of advertising funds.</pp   
    </li>
    <li class="img">
