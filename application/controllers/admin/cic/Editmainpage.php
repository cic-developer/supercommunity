 ...
 */
class Editmainpage extends CB_Controller
{
	 ...
	 * 페이지 이동시 필요한 정보입니다
	 */
	public $pagedir = 'cic/editmainpage';
	...
	{
		// 이벤트 라이브러리를 로딩합니다
		$eventname = 'event_admin_cic_editmainpage_index';
	...
	{
		// 이벤트 라이브러리를 로딩합니다
		$eventname = 'event_admin_cic_editmainpage_background';
		$this->load->event($eventname);
		 ...
		 * 어드민 레이아웃을 정의합니다
		 */
		$layoutconfig = array('layout' => 'layout', 'skin' => 'background');
		$view['layout'] = $this->managelayout->admin($layoutconfig, $this->cbconfig->get_device_view_type());
		$this->data = $view;
		$this->layout = element('layout_skin_file', element('layout', $view));
		$this->view = element('view_skin_file', element('layout', $view));
