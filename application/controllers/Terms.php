...
class Terms extends CB_Controller
{
	...
	function provision_mobile(){
       //페이지별 언어팩 로드
		$this->lang->load('cic_cic_etc_mobile_provision', $this->session->userdata('lang'));	
		/**
		 * 레이아웃을 정의합니다
		 */
		$page_title = $this->cbconfig->item('site_meta_title_main');
	...
	function privacy_mobile(){
       //페이지별 언어팩 로드
		$this->lang->load('cic_cic_etc_mobile_privacy', $this->session->userdata('lang'));	
